 ...
 */
int ZLIB_INTERNAL inflate_table(enum codetype type, unsigned short FAR *lens, unsigned codes, struct code FAR * FAR *table, unsigned FAR *bits, unsigned short FAR *work)
{
